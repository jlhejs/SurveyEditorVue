...
export class SurveyObjectEditor {
  ...
  public onAfterRenderCallback: (object: any,  htmlElement: HTMLElement,  property: SurveyObjectProperty) => any;

  constructor(public propertyEditorOptions: ISurveyObjectEditorOptions|any = null) {
