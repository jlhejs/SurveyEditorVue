...
var AceAjax:any=window["AceAjax"]
var ace:any=window["ace"]
export class SurveyEmbedingWindow {
  private jsonValue: any;
  private surveyEmbedingHead: any;
  private surveyEmbedingJava: any;
  private surveyEmbedingBody: any;
  koHeadText: any;
  koBodyText: any;
  koJavaText: any;
  ...
  private createEditor(elementName: string): any {
  ...
  private setTextToEditor(editor: any, koText: any, text: string) {
