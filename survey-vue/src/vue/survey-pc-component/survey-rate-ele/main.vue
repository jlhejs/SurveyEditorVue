<template>
  <div
    ...
    <span  class="el-rate__item" :style="{ cursor: rateDisabled ? 'auto' : 'pointer' }">
      <i v-if="showClear"
      class="el-rate__icon el-icon-circle-close el-input__clear"
      @mousedown.prevent
      @click="clear"
    ></i>
    </span>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      iconClassesComputed() {
        if( this.voidIconClass=="el-icon-star-off"){
          return ['el-icon-star-on', 'el-icon-star-on', 'el-icon-star-on']
        }
        return [this.voidIconClass,this.voidIconClass,this.voidIconClass]
      },
      ...
      classMap() {
        return Array.isArray(this.iconClassesComputed)
          ? {
            [this.lowThreshold]: this.iconClassesComputed[0],
            [this.highThreshold]: { value: this.iconClassesComputed[1], excluded: true },
            [this.max]: this.iconClassesComputed[2]
          } : this.iconClassesComputed;
      },
