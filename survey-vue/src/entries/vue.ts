...
export { Slider } from "../vue/slider.vue";
export { Datetime } from "../vue/datetime.vue";
export { Rate } from "../vue/survey-rate.vue";
...
export { SurveyHeeader } from "../vue/survey-header.vue";
export { SurveyCopyright } from "../vue/survey-copyright.vue";
