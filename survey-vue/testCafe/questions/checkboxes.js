...
frameworks.forEach(framework => {
  ...
  test(`choose none`, async t => {
    ...
    await t
      .click(`.survey-q_select_column:nth-child(2) div:nth-child(2) label input`)
      .click(`.survey-q_select_column:nth-child(5) div:nth-child(2) label input`)
      .click(`.survey-q_select_column:nth-child(4) div:nth-child(1) label input`)
      .click(`.survey-q_select_column:nth-child(2) div:nth-child(4) label input`)
